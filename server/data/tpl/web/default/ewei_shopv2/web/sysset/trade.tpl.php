...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
    ...
    <div class='form-group-title'>支付设置</div>
    <div class="form-group">
        <label class="col-sm-2 control-label">线下支付说明</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <textarea  name="data[offline_pay_desc]" class="form-control" value="<?php  echo $data['offline_pay_desc'];?>" ><?php  echo $data['offline_pay_desc'];?></textarea>
            <span class='help-block'>用户选择线下支付时的说明</span>
            <?php  } else { ?>
            <input type="hidden" name="data[refundcontent]" value="<?php  echo $data['offline_pay_desc'];?>"/>
            <div class='form-control-static'>
                <?php  echo $data['refundcontent'];?>
            </div>
            <?php  } ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">正式版支付按钮</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <label class='radio-inline'><input type='radio' name='data[paybtn]' value='0' <?php  if(empty($data['paybtn'])) { ?>checked<?php  } ?> onclick="$('.recharge-group').show()"/> 隐藏</label>
            <label class='radio-inline'><input type='radio' name='data[paybtn]' value='1' <?php  if($data['paybtn']=='1') { ?>checked<?php  } ?>  onclick="$('.recharge-group').hide()"/> 显示</label>
            <?php  } else { ?>
            <div class='form-control-static'><?php  if($data['paybtn']==1) { ?>显示<?php  } else { ?>隐藏<?php  } ?></div>
            <?php  } ?>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">测试版支付按钮</label>
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.trade.edit')) { ?>
            <label class='radio-inline'><input type='radio' name='data[beta_paybtn]' value='0' <?php  if(empty($data['beta_paybtn'])) { ?>checked<?php  } ?> onclick="$('.recharge-group').show()"/> 隐藏</label>
            <label class='radio-inline'><input type='radio' name='data[beta_paybtn]' value='1' <?php  if($data['beta_paybtn']=='1') { ?>checked<?php  } ?>  onclick="$('.recharge-group').hide()"/> 显示</label>
            <?php  } else { ?>
            <div class='form-control-static'><?php  if($data['beta_paybtn']==1) { ?>显示<?php  } else { ?>隐藏<?php  } ?></div>
            <?php  } ?>
        </div>
    </div>
