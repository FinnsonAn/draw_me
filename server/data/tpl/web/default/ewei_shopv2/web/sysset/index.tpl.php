...
<div class="page-heading"> <h2>商城设置</h2> </div>
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">会员中心头部背景图</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.shop.edit')) { ?>
                        <?php  echo tpl_form_field_image('data[uc_bg]', $data['uc_bg'])?>
                        <span class='help-block'>建议尺寸720*200</span>
                        <?php  } else { ?>
                        <input type="hidden" name="data[uc_bg]" value="<?php  echo $data['uc_bg'];?>"/>
                        <?php  if(!empty($data['uc_bg'])) { ?>
                        <a href='<?php  echo tomedia($data['uc_bg'])?>' target='_blank'>
                           <img src="<?php  echo tomedia($data['uc_bg'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                        </a>
                        <?php  } ?>
                        <?php  } ?>
                 ...
                 <div class="form-group">
                    <label class="col-sm-2 control-label">联系我们头部图片</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.shop.edit')) { ?>
                        <?php  echo tpl_form_field_image('data[contact_bg]', $data['contact_bg'])?>
                        <span class='help-block'>建议尺寸720*300</span>
                        <?php  } else { ?>
                        <input type="hidden" name="data[contact_bg]" value="<?php  echo $data['contact_bg'];?>"/>
                        <?php  if(!empty($data['contact_bg'])) { ?>
                        <a href='<?php  echo tomedia($data['contact_bg'])?>' target='_blank'>
                           <img src="<?php  echo tomedia($data['contact_bg'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                        </a>
                        <?php  } ?>
                        <?php  } ?>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">充值中心头部图片</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.shop.edit')) { ?>
                        <?php  echo tpl_form_field_image('data[recharge_bg]', $data['recharge_bg'])?>
                        <span class='help-block'>建议尺寸720*300</span>
                        <?php  } else { ?>
                        <input type="hidden" name="data[recharge_bg]" value="<?php  echo $data['recharge_bg'];?>"/>
                        <?php  if(!empty($data['recharge_bg'])) { ?>
                        <a href='<?php  echo tomedia($data['recharge_bg'])?>' target='_blank'>
                           <img src="<?php  echo tomedia($data['recharge_bg'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                        </a>
                        <?php  } ?>
                        <?php  } ?>
				...
				<div class="form-group">
                    <label class="col-sm-2 control-label">商品无缩略图图标</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.shop.edit')) { ?>
                        <?php  echo tpl_form_field_image('data[nothumb]', $data['nothumb'])?>
                        <span class='help-block'>商品售罄图标，建议尺寸400*400，空则不显示</span>
                        <?php  } else { ?>
                        <input type="hidden" name="data[nothumb]" value="<?php  echo $data['nothumb'];?>"/>
                        <?php  if(!empty($data['nothumb'])) { ?>
                        <a href='<?php  echo tomedia($data['nothumb'])?>' target='_blank'>
                        <img src="<?php  echo tomedia($data['nothumb'])?>" style='width:200px;border:1px solid #ccc;padding:1px' />
                        </a>
                        <?php  } ?>
                        <?php  } ?>
                    </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9 col-xs-12">
                    <?php if(cv('sysset.shop.edit')) { ?>
                   	<select class="form-control select2" id="data[webtype]" name="data[webtype]">
                        <?php  if(is_array($webtypes)) { foreach($webtypes as $k => $type) { ?>
                        <option value="<?php  echo $k;?>" <?php  if($data['webtype'] == $k) { ?>selected="true"<?php  } ?>><?php  echo $type;?></option>
                        <?php  } } ?>
                    </select>
                    <?php  } else { ?>
                    <input type="hidden" name="data[name]" value="<?php  echo $data['name'];?>"/>
                    <div class='form-control-static'><?php  echo $webtypes[$data['webtype']];?></div>
                    <?php  } ?>
                </div>
             </div>
