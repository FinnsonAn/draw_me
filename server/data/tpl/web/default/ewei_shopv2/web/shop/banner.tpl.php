...
<div class="page-heading"> 
    <span class='pull-right'>
        <?php if(cv('shop.banner.add')) { ?>
        	<a class='btn btn-primary btn-sm' href="<?php  echo webUrl('shop/banner/add', array('position_id' => $position_id))?>"><i class='fa fa-plus'></i> 添加广告</a>
        <?php  } ?>
    </span>
                ...
                <td>
                    ...
                    <td style="text-align:left;">
                        <?php if(cv('shop.banner.view|shop.banner.edit')) { ?>
                        	<a href="<?php  echo webUrl('shop/banner/edit', array('id' => $row['id'], 'position_id' => $position_id))?>" class="btn btn-default btn-sm">
                        		<i class='fa fa-edit'></i> <?php if(cv('shop.banner.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>
                        	</a>
                        <?php  } ?>
                        <?php if(cv('shop.banner.delete')) { ?>
                        	<a data-toggle='ajaxRemove' href="<?php  echo webUrl('shop/banner/delete', array('id' => $row['id'], 'position_id' => $position_id))?>"class="btn btn-default btn-sm" data-confirm='确认要删除此广告吗?'><i class="fa fa-trash"></i> 删除</a>
                        <?php  } ?>
                    </td>
                </tr>
                <?php  } } ?> 
