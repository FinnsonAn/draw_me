...
<div class="form-group">
    ...
    <?php if( ce('goods' ,$item) ) { ?>
    <div class="col-sm-9 subtitle">
        <input type="text" name="info" class="form-control" value="<?php  echo $item['info'];?>" />
    </div>
...
<div class="form-group">
    ...
    <?php if( ce('goods' ,$item) ) { ?>
    <div class="col-sm-9 subtitle">
        <input type="text" name="label" class="form-control" value="<?php  echo $item['label'];?>" />
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-8 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        <select id="brand_id"  name='brand_id' class="form-control" style='width:605px;' >
        	<option value="">请选择</option>
            <?php  if(is_array($brands)) { foreach($brands as $b) { ?>
            <option value="<?php  echo $b['id'];?>" <?php  if($b['id'] == $item['brand_id']) { ?>selected<?php  } ?> ><?php  echo $b['brand_name'];?></option>
            <?php  } } ?>
        </select>
        <?php  } else { ?>
        <div class='form-control-static ops'>
...
<div class="form-group price" <?php  if($item['type']==4) { ?>  style="display: none"<?php  } ?>>
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
            <label class="checkbox-inline"><input type="checkbox" name="meetingprice" id="meetingprice" value="1" <?php  if($item['meetingprice'] == 1) { ?>checked="true"<?php  } ?>   /> 面议（勾选后价格将自动变为0）</label>
        </div>
        <span class='help-block'>尽量填写完整，有助于于商品销售的数据分析</span>
        <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
             ...
             <input type="text" name="min_person" id="min_person" class="form-control" value="<?php  echo $item['min_person'];?>"  /> 
             <span class="input-group-addon">人 - 最高</span>
             <input type="text" name="max_person" id="max_person" class="form-control" value="<?php  echo $item['max_person'];?>"/> 
             <span class="input-group-addon">人。每增加1人，增长</span>
             <input type="text" name="person_price" id="person_price" class="form-control" value="<?php  echo $item['person_price'];?>"  /> 
             <span class="input-group-addon">元</span>
         </div>  	
		 <span class='help-block'>左边框是最低人数，右边框是最高人数，若是1人，两个输入框都填写1</span>
        
        <?php  } else { ?>
        <div class='form-control-static'><?php  if($item['person'] == 1) { ?>单人<?php  } else { ?>多人<?php  } ?></div>
        <?php  } ?>
    </div>
</div>
<script>
$(function(){
	$('#meetingprice').click(function(){
...
<div class="form-group interval"  <?php  if($item['type']!=4) { ?>  style="display: none"<?php  } ?> >
 ...
 <div class="form-group">
            <label class="col-sm-2 control-label">小缩略图</label>
            <div class="col-sm-9 col-xs-12">
               <?php if( ce('goods' ,$item) ) { ?>
                <?php  echo tpl_form_field_image('tiny_thumb', $item['tiny_thumb'])?>
                <span class="help-block">建议尺寸:120*120 </span>
                <?php  } else { ?>
                <?php  if(!empty($item['tiny_thumb'])) { ?>
                <a href='<?php  echo tomedia($item['tiny_thumb'])?>' target='_blank'>
                   <img src="<?php  echo tomedia($item['tiny_thumb'])?>" style='width:100px;border:1px solid #ccc;padding:1px' />
                </a>
                <?php  } ?>
                <?php  } ?>
            </div>
...
<div class="form-group">
    <label class="col-sm-2 control-label">线下支付</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        <label class="checkbox-inline" >
            <input type="checkbox" name="offline_pay" value="1" <?php  if($item['offline_pay'] ==1) { ?>checked="true"<?php  } ?>  /> 支持
        </label>
        <?php  } else { ?>
        <div class='form-control-static'><?php  if(!empty($item['cash'])) { ?>支持<?php  } else { ?>不支持<?php  } ?></div>
        <?php  } ?>
