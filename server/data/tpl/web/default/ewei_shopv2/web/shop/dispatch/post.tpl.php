...
<div class="page-heading"> 
    ...
    <h2><?php  if(!empty($dispatch['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>配送方式 <small><?php  if(!empty($dispatch['id'])) { ?>修改【<?php  echo $dispatch['dispatchname'];?>】<?php  } ?></small></h2>
</div>
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <table  style='width:110%;'>
            ...
            <tr>
                ...
                <th style="width:120px;">满额包邮(元)</th>
            ...
            <tr>
                ...
                <td class="show_h text-center">
                    <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
                    <input type="text" value="<?php echo empty($dispatch['firstweight'])?1000:$dispatch['firstweight']?>" class="form-control" name="default_firstweight" style="width:80px;"></td>
                <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
        <label class='radio-inline'>
            <input type='radio' name='isdispatcharea' value='0' <?php  if($dispatch['isdispatcharea']==0) { ?>checked<?php  } ?> /> 不配送区域
        </label>
        <label class='radio-inline'>
            <input type='radio' name='isdispatcharea' value='1' <?php  if($dispatch['isdispatcharea']==1) { ?>checked<?php  } ?> /> 只配送区域
        </label>
        <?php  } else { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label"><span id="dispatcharea_name"><?php  if(empty($dispatch['isdispatcharea'])) { ?>不<?php  } else { ?>只<?php  } ?></span>配送区域</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
        <label class='radio-inline'>
            <input type='radio' name='enabled' value=1' <?php  if($dispatch['enabled']==1) { ?>checked<?php  } ?> /> 启用
        </label>
        <label class='radio-inline'>
            <input type='radio' name='enabled' value=0' <?php  if($dispatch['enabled']==0) { ?>checked<?php  } ?> /> 禁用
        </label>
        <?php  } else { ?>
