                ...
                <?php  if(count($sendtasks)>0) { ?>
                    ...
                    <tr>
                        ...
                        <td  style="overflow:visible;position:relative;text-align: right;">
                            <?php if(cv('sale.coupon')) { ?>
                                <a  class='btn btn-default btn-sm' href="<?php  echo webUrl('sale.coupon.sendtask/edit', array('id' => $item['id'],'page'=>$page))?>" title="<?php if(cv('sale.coupon')) { ?>编辑<?php  } else { ?>查看<?php  } ?>"><i class='fa fa-edit'></i> <?php if(cv('sale.coupon')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a>
                            <?php  } ?>
                            <?php if(cv('sale.coupon')) { ?>
