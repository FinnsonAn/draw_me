    ...
    <form <?php if( ce('shop.verify.store' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php  echo $item['id'];?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                          <?php if( ce('shop.verify.store' ,$item) ) { ?>
                                <?php  echo tpl_form_field_multi_image('logos',$piclist)?>
                                 <span class="help-block image-block">建议为正方型图 尺寸建议宽度为640，并保持图片大小一致</span>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class="help-block">多个电话请用英文输入状态下的","隔开 </span>
                               <?php  } else { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <input type="text" name="qq" class="form-control" value="<?php  echo $item['qq'];?>" />
                               <?php  } else { ?>
                        <div class='form-control-static'><?php  echo $item['qq'];?></div>
                        <?php  } ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                               <?php if( ce('shop.verify.store' ,$item) ) { ?>
                        <input type="text" name="web" class="form-control" value="<?php  echo $item['web'];?>" />
                               <?php  } else { ?>
                        <div class='form-control-static'><?php  echo $item['web'];?></div>
                        <?php  } ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <input type="text" name="email" class="form-control" value="<?php  echo $item['email'];?>" />
                               <?php  } else { ?>
                        <div class='form-control-static'><?php  echo $item['email'];?></div>
                        <?php  } ?>
                    </div>
                </div>
                <div class="form-group">
