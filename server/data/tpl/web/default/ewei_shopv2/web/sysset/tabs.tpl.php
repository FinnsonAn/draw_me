...
<ul>
    ...
    <?php if(cv('sysset.wxapp')) { ?><li <?php  if($_W['routes']=='sysset.wxapp') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sysset/wxapp')?>">小程序设置</a></li><?php  } ?>
...
<ul>
	<?php if(cv('sysset.wxtmpl')) { ?><li <?php  if($_W['routes']=='sysset.wxapp') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sysset/wxtmpl')?>">小程序模板设置</a></li><?php  } ?>
