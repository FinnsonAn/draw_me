...
<ul>
    <?php if(cv('shop.adv')) { ?><li <?php  if($_W['action'] == 'shop.adv') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/adv/plist')?>">幻灯片</a></li><?php  } ?>
    <?php if(cv('shop.nav')) { ?><li <?php  if($_W['action'] == 'shop.nav') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/nav/glist')?>">导航图标</a></li><?php  } ?>
    <?php if(cv('shop.banner')) { ?><li <?php  if($_W['action'] == 'shop.banner') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/banner/plist')?>">广告</a></li><?php  } ?>
    <?php if(cv('shop.section')) { ?><li <?php  if($_W['action'] == 'shop.section') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/section')?>">版块设置</a></li><?php  } ?>
...
<ul>
    ...
    <?php if(cv('shop.notice')) { ?><li <?php  if($_W['action'] == 'shop.notice') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/notice')?>">系统文章</a></li><?php  } ?>
    <?php if(cv('shop.notice')) { ?><li <?php  if($_W['action'] == 'shop.notice') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('shop/notice/catelist')?>">文章分类</a></li><?php  } ?>
