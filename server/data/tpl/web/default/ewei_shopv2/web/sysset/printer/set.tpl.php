...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.printer.set')) { ?>
            <label class="radio-inline"><input type="radio" name="printer_pay" value="0" <?php  if(empty($data['printer_pay'])) { ?>checked<?php  } ?>> 不打印</label>
            <label class="radio-inline"><input type="radio" name="printer_pay" value="1" <?php  if(!empty($data['printer_pay'])) { ?>checked<?php  } ?>> 打印</label>
            <?php  } else { ?>
            <div class='form-control-static'><?php  if(empty($data['printer_pay'])) { ?>不打印<?php  } else { ?>打印<?php  } ?></div>
            <?php  } ?>
        </div>
    </div>
     <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.printer.set')) { ?>
            <label class="radio-inline"><input type="radio" name="printer_offline" value="0" <?php  if(empty($data['printer_offline'])) { ?>checked<?php  } ?>> 不打印</label>
            <label class="radio-inline"><input type="radio" name="printer_offline" value="1" <?php  if(!empty($data['printer_offline'])) { ?>checked<?php  } ?>> 打印</label>
            <?php  } else { ?>
            <div class='form-control-static'><?php  if(empty($data['printer_offline'])) { ?>不打印<?php  } else { ?>打印<?php  } ?></div>
            <?php  } ?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <div class="input-group">
             <input type="text" name="mem_fontsize" class="form-control"  value="<?php  echo $data['mem_fontsize'];?>" placeholder="" /><span class="input-group-addon">px</span>
			</div>
            <?php  } else { ?>
            <div class='form-control-static'><?php  echo $data['mem_fontsize'];?>px</div>
            <?php  } ?>
        </div>
    </div>
     <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('sysset.printer.set')) { ?>
            <div class="input-group">
             <input type="text" name="mem_width" class="form-control"  value="<?php  echo $data['mem_width'];?>" placeholder="" /><span class="input-group-addon">px</span>
			</div>

            <?php  } else { ?>
            <div class='form-control-static'><?php  echo $data['mem_width'];?>px</div>
            <?php  } ?>
        </div>
    </div>
    <div class="form-group">
