...
<div class="step-region" >
    <ul class="ui-step ui-step-4" >
        ...
        <div class="ui-step-title">确认发货</div>
...
"><i class='fa fa-question-circle'></i></a></td>
                        ...
                        <tr>
                            ...
                            <td> <?php  echo $item['payment']['name'];?></td>
                        </tr>
                ...
                <tr>
                    ...
                    <td  style='border:none;text-align:right;'><?php  echo date('Y-m-d H:i',$v['verifytime'])?></td>
                        ...
                        <?php  } ?>
                         ...
                         <tr>
                            <td  style='border:none;text-align:right;'>客户电话：</td>
                            <td  style='word-break: break-all;white-space: normal'><?php  echo $item['mobile'];?></td>
                        </tr>
                        <tr>
                            <td  style='border:none;text-align:right;'>照片类型：</td>
                            <td  style='word-break: break-all;white-space: normal'><label class='label label-default'><?php  echo $item['pictype_str'];?></label></td>
                        </tr>
                        <?php  if($item['upics']) { ?>
                        <tr>
                            <td  style='border:none;text-align:right;'>客户图片：</td>
                            <td  style='word-break: break-all;white-space: normal'>
                            	<?php  if(is_array($item['upics'])) { foreach($item['upics'] as $pic) { ?>
                                <a href="<?php  echo $pic;?>" target="_blank"><img src="<?php  echo $pic;?>" width="100px" height="auto" style="padding-right:20px;"></a>
                                <?php  } } ?>
                            </td>
                        </tr>
                        <?php  } ?>
        ...
        <div class="form-group" style='padding:0 10px;'>
            <table class='ordertable' style='table-layout:fixed'>
                <tr>
                    <td style='width:80px'>姓名：</td>
                    <td>
                    	(ID: <?php  echo $author['id'];?>)<?php  echo $author['name'];?> <?php  echo $author['mobile'];?>
                    </td>
                </tr>
                <tr>
                    <td style='width:80px'>微信：</td>
                    <td>
                    	<img src="<?php  echo $author[wechat]['avatar'];?>" width="50px" height="50px"> (ID: <?php  echo $author['mid'];?>)<?php  echo $author['wechat']['nickname'];?>
                    </td>
                </tr>
                <tr>
                    <td style='width:80px'>上传状态：</td>
                    <td>
                    	<?php  if($item['upload_case_time'] > 0) { ?>于<?php  echo $item['upload_time_fm'];?>上传<?php  } else { ?>未上传<?php  } ?>
                    </td>
                </tr>
                <tr>
                    <td  style='border:none;text-align:right;'>上传图片：</td>
                    <td>
                    <div class="col-sm-9 col-xs-12 gimgs">
                        <?php  if($item['status'] == 1 || $item['status'] == 2) { ?>
                        <?php  echo tpl_form_field_multi_image('thumbs',$item['uploads'])?>
                        <?php  } else { ?>
                        <?php  if(is_array($item['uploads'])) { foreach($item['uploads'] as $p) { ?>
                ...
                <tr>
                    <td colspan="2" align="center" width="100%" style="text-align:center">
                    	 <input type="submit" class="btn btn-primary" style="clear:both; " value="上传作品" />
                    </td>
                </tr>
            </table>   
        </div>                         
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td style='color:red;font-weight:bold;text-align: right;'>
                        ...
                        <?php  } else { ?>
                            <?php  echo $goods['oldprice'];?>/<?php  echo $goods['realprice'];?>
