    ...
    <table class="table table-responsive table-hover" >
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td><?php if(cv('shop.adv.view')) { ?><a href="<?php  echo webUrl('shop/adv', array('position_id' => $row['pid']))?>" class="btn btn-default btn-sm" title="查看幻灯片">查看幻灯片(<?php  echo $row['counts'];?>)</a><?php  } ?></td>
                    <td>
                    ...
                    <td style="text-align:left;">
                        ...
                        &nbsp; 
                        <a href="<?php  echo webUrl('shop/adv/pedit', array('id' => $row['pid']))?>" class="btn btn-default btn-sm" title="<?php if(cv('shop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>"><i class="fa fa-edit"></i></a><?php  } ?>
                        <?php  if(!$row['is_system']) { ?><?php if(cv('shop.adv.delete')) { ?><a data-toggle='ajaxRemove' href="<?php  echo webUrl('shop/adv/pdelete', array('id' => $row['pid']))?>" class="btn btn-default btn-sm" data-confirm='确认删除此位置吗，连同包括的幻灯片也会一起删除?'><i class="fa fa-times"></i></a><?php  } ?><?php  } ?>
                    </td>
                </tr>
                <?php  } } ?> 
                <tr>
